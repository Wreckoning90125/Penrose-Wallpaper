...
// uniformly. `vcount` is 3 for Penrose, 4 for dodecagonal, 6 for Chair.
// =============================================================================

struct Tile {
    float x[6];
    float y[6];
    uint8_t vcount;   // 3 for P3/P2 triangles, 4 for dodeca rhombs, 6 for chair
    uint8_t type;     // 0=L,1=S Penrose; 0..3 chair orient; 0..2 dodeca shape
};

enum class Family : int { P3 = 0, P2 = 1, Chair = 2, Dodecagonal = 3 };
