 ...
 */
internal data class MaterialPreset(val name: String, val values: Map<String, Int>)
...
internal object MaterialPresets {
    ...
    val all: List<MaterialPreset> = listOf(
        ...
        MaterialPreset("Brushed metal", bundle(
        ...
        MaterialPreset("Oil-slick", bundle(
