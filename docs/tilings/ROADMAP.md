...
sophistication** (`docs/render/physical-material-rendering.md`, the
five-phase physical-material build). The tiling track's committed next item
is the Hat / Spectre einstein family — see *Obvious next step* below.
