...
export function App() {
  ...
  const renderInputsRef = useRef<RenderInputs>({ geometry: true, lighting: true, color: true, material: true, projection: true, fieldDisplace: true, fieldRelief: true, fieldColor: true });
